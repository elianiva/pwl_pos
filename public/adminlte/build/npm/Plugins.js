...
const Plugins = [
  // jQuery
  {
    from: 'node_modules/jquery/adminlte',
    to: 'plugins/jquery'
  },
  // Popper
  {
    from: 'node_modules/popper.js/adminlte',
    to: 'plugins/popper'
  },
  // Bootstrap
  {
    from: 'node_modules/bootstrap/adminlte/js',
  ...
  // Chart.js
  {
    from: 'node_modules/chart.js/adminlte/',
    to: 'plugins/chart.js'
  },
  // jQuery UI
  {
    from: 'node_modules/jquery-ui-adminlte/',
    to: 'plugins/jquery-ui'
  },
  // Flot
  {
    from: 'node_modules/flot/adminlte/es5/',
    to: 'plugins/flot'
  },
  {
  ...
  // Summernote
  {
    from: 'node_modules/summernote/adminlte/',
    to: 'plugins/summernote'
  },
  // Bootstrap Slider
  {
    from: 'node_modules/bootstrap-slider/adminlte/',
    to: 'plugins/bootstrap-slider'
  },
  {
    from: 'node_modules/bootstrap-slider/adminlte/css',
    to: 'plugins/bootstrap-slider/css'
  },
  // Bootstrap Colorpicker
  {
    from: 'node_modules/bootstrap-colorpicker/adminlte/js',
    to: 'plugins/bootstrap-colorpicker/js'
  },
  {
    from: 'node_modules/bootstrap-colorpicker/adminlte/css',
  ...
  {
    from: 'node_modules/jszip/adminlte',
    to: 'plugins/jszip'
  },
  {
  ...
  // inputmask
  {
    from: 'node_modules/inputmask/adminlte/',
  ...
  {
    from: 'node_modules/jqvmap-novulnerability/adminlte/',
    to: 'plugins/jqvmap'
  },
  // jQuery Mapael
  {
  ...
  // jQuery Knob
  {
    from: 'node_modules/jquery-knob-chif/adminlte/',
    to: 'plugins/jquery-knob'
  },
  // pace-progress
  {
    from: 'node_modules/@lgaitan/pace-progress/adminlte/',
    to: 'plugins/pace-progress'
  },
  // Select2
  {
    from: 'node_modules/select2/adminlte/',
    to: 'plugins/select2'
  },
  {
    from: 'node_modules/@ttskch/select2-bootstrap4-theme/adminlte/',
  ...
  // SweetAlert2
  {
    from: 'node_modules/sweetalert2/adminlte/',
  ...
  // jsGrid
  {
    from: 'node_modules/jsgrid/adminlte',
    to: 'plugins/jsgrid'
  },
  {
  ...
  {
    from: 'node_modules/bootstrap4-duallistbox/adminlte',
    to: 'plugins/bootstrap4-duallistbox/'
  },
  // filterizr
  {
    from: 'node_modules/filterizr/adminlte',
    to: 'plugins/filterizr/'
  },
  // ekko-lightbox
  {
    from: 'node_modules/ekko-lightbox/adminlte',
    to: 'plugins/ekko-lightbox/'
  },
  // bootstrap-switch
  {
    from: 'node_modules/bootstrap-switch/adminlte',
    to: 'plugins/bootstrap-switch/'
  },
  // jQuery Validate
  {
    from: 'node_modules/jquery-validation/adminlte/',
    to: 'plugins/jquery-validation'
  },
  // bs-custom-file-input
  {
    from: 'node_modules/bs-custom-file-input/adminlte/',
    to: 'plugins/bs-custom-file-input'
  },
  // bs-stepper
  {
    from: 'node_modules/bs-stepper/adminlte/',
  ...
  // dropzonejs
  {
    from: 'node_modules/dropzone/adminlte/',
    to: 'plugins/dropzone'
  },
  // uPlot
  {
    from: 'node_modules/uplot/adminlte/',
    to: 'plugins/uplot'
  }
]
