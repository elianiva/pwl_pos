...
const Plugins = [
  ...
  // Chart.js
  {
    from: 'node_modules/chart.js/template/',
    to: 'plugins/chart.js'
  },
  // jQuery UI
  {
    from: 'node_modules/jquery-ui-template/',
    to: 'plugins/jquery-ui'
  },
  // Flot
  {
    from: 'node_modules/flot/template/es5/',
    to: 'plugins/flot'
  },
  {
  ...
  // Summernote
  {
    from: 'node_modules/summernote/template/',
    to: 'plugins/summernote'
  },
  // Bootstrap Slider
  {
    from: 'node_modules/bootstrap-slider/template/',
    to: 'plugins/bootstrap-slider'
  },
  {
    from: 'node_modules/bootstrap-slider/template/css',
    to: 'plugins/bootstrap-slider/css'
  },
  // Bootstrap Colorpicker
  {
    from: 'node_modules/bootstrap-colorpicker/template/js',
    to: 'plugins/bootstrap-colorpicker/js'
  },
  {
    from: 'node_modules/bootstrap-colorpicker/template/css',
  ...
  {
    from: 'node_modules/jszip/template',
    to: 'plugins/jszip'
  },
  {
  ...
  // inputmask
  {
    from: 'node_modules/inputmask/template/',
  ...
  {
    from: 'node_modules/jqvmap-novulnerability/template/',
    to: 'plugins/jqvmap'
  },
  // jQuery Mapael
  {
  ...
  // jQuery Knob
  {
    from: 'node_modules/jquery-knob-chif/template/',
    to: 'plugins/jquery-knob'
  },
  // pace-progress
  {
    from: 'node_modules/@lgaitan/pace-progress/template/',
    to: 'plugins/pace-progress'
  },
  // Select2
  {
    from: 'node_modules/select2/template/',
    to: 'plugins/select2'
  },
  {
    from: 'node_modules/@ttskch/select2-bootstrap4-theme/template/',
  ...
  // SweetAlert2
  {
    from: 'node_modules/sweetalert2/template/',
  ...
  // jsGrid
  {
    from: 'node_modules/jsgrid/template',
    to: 'plugins/jsgrid'
  },
  {
  ...
  {
    from: 'node_modules/bootstrap4-duallistbox/template',
    to: 'plugins/bootstrap4-duallistbox/'
  },
  // filterizr
  {
    from: 'node_modules/filterizr/template',
    to: 'plugins/filterizr/'
  },
  // ekko-lightbox
  {
    from: 'node_modules/ekko-lightbox/template',
    to: 'plugins/ekko-lightbox/'
  },
  // bootstrap-switch
  {
    from: 'node_modules/bootstrap-switch/template',
    to: 'plugins/bootstrap-switch/'
  },
  // jQuery Validate
  {
    from: 'node_modules/jquery-validation/template/',
    to: 'plugins/jquery-validation'
  },
  // bs-custom-file-input
  {
    from: 'node_modules/bs-custom-file-input/template/',
    to: 'plugins/bs-custom-file-input'
  },
  // bs-stepper
  {
    from: 'node_modules/bs-stepper/template/',
  ...
  // dropzonejs
  {
    from: 'node_modules/dropzone/template/',
    to: 'plugins/dropzone'
  },
  // uPlot
  {
    from: 'node_modules/uplot/template/',
    to: 'plugins/uplot'
  }
]
