...
@section('content')
    <div class="card card-outline card-primary">
        ...
        <div class="card-body">
            <form
                method="POST" action="{{ url('/category/'.$user->user_id) }}"
            ...
            >
                ...
                <div class="form-group row">
                    ...
                    <div class="col-11">
                        <input
                            type="text" class="form-control" id="kategori_kode" name="kategori_kode"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-11">
                        <input
                            type="text" class="form-control" id="kategori_nama" name="kategori_nama"
